...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <meta name="author" content="Jhonson Junior" />
            ...
            <div class="layout-wrap">
                ...
                <div class="section-content-right">
                    ...
                    <div class="main-content">
                      <!-- sinalizando o local que sera substituido por outro conteudo section: -->
                        @yield('content') 

                        <div class="bottom-page">
                            <div class="body-text">Copyright ©@php echo date('Y'); @endphp Jhonson Junior</div>
                        </div>
                    </div>
